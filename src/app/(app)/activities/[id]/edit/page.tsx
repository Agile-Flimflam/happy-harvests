...
import { EditActivityContent, type EditActivityContentProps } from '@/components/activities/EditActivityContent'
      ...
      <Card>
        ...
        <CardContent>
          <form action={updateActivity}>
            ...
            <EditActivityContent
              activity={activity as unknown as EditActivityContentProps['activity']}
              locations={(locations || []).map((l) => ({ id: l.id as string, name: l.name as string })) as EditActivityContentProps['locations']}
            />
          </form>
        </CardContent>
      </Card>
